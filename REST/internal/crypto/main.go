...
import (
	...
	"wallet/REST/config"
	"wallet/REST/internal/crypto/networks/bitcoin"
	"wallet/REST/internal/crypto/networks/dogecoin"
	"wallet/REST/internal/crypto/networks/ethereum"
	"wallet/REST/internal/crypto/networks/litecoin"
	"wallet/REST/internal/crypto/networks/solana"
	"wallet/REST/internal/crypto/networks/theopennetwork"
	"wallet/REST/internal/crypto/networks/tron"
)
...
func (s *CryptoService) CreateWalletList(userId int64) *pb.WalletList {
	...
	result := make(chan *pb.WalletItem, len(coinList))
	var wg sync.WaitGroup
	walletList := &pb.WalletList{
		Wallet: make([]*pb.WalletItem, 0, len(coinList)),
	}
